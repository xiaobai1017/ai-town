...
export function useGameLoop() {
    ...
    const addAgent = () => {
        ...
        const newAgent = new Agent(newId, randomName, randomRole, { x: Math.floor(Math.random() * 20) + 5, y: Math.floor(Math.random() * 10) + 5 }, randomColor, randomEmoji, randomDescription);
